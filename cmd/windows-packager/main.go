...
func main() {
	...
	flag.StringVar(&cfg.OVMFCode, "ovmf-code", "/usr/share/OVMF/OVMF_CODE.fd", "Path to OVMF code fd")
	flag.StringVar(&cfg.OVMFVarsTemplate, "ovmf-vars", "/usr/share/OVMF/OVMF_VARS.fd", "Path to OVMF vars template fd")
